package com.application.erp.user.domain.repository.impl;
...
import com.application.erp.user.domain.repository.UserRepositoryCustom;
...
import static com.application.erp.jooq.tables.TbAccessGroups.TB_ACCESS_GROUPS;
import static com.application.erp.jooq.tables.TbUsers.TB_USERS;
import static com.application.erp.jooq.tables.TbUsersAccessGroups.TB_USERS_ACCESS_GROUPS;
...
public class UserRepositoryCustomImpl implements UserRepositoryCustom {
    ...
    @Override
    public Page<User> findUsersByFilter(UserFilter filter, Pageable pageable) {
